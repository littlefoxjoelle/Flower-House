...
<div class="block_search">
    ...
    <div class="categories">
        ...
        <ul class="sorting-list">
            <li><a href="Hatboxes.php?sort=none">Без сортировки</a></li>
            <li><a href="Hatboxes.php?sort=price-asc">От дешёвых к дорогим</a></li>
            <li><a href="Hatboxes.php?sort=price-desc">От дорогих к дешёвым</a></li>
        </ul>
        </ul>
    </div>
...
$res_count = mysqli_query($link, "SELECT COUNT(*) FROM `товары` WHERE `Код категории`='3' ORDER BY  $sorting");
...
for ($i = 1; $i <= $str_page; $i++)
{
    ...
    <ul class="hr">
    <li>
    <a href = Hatboxes.php?page='.$i.'>'.$i.'</a>
    </li>
    </ul>';
}
?>
...
$result = mysqli_query($link,"SELECT * FROM `товары` WHERE `Код категории`='3' ORDER BY  $sorting LIMIT $number, $limit");
